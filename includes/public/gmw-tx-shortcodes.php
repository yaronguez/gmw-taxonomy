...
/**
 * GMW TX Shortcode - Shortcode display location of a taxonomy term
 * @version 1.0
 * @author Eyal Fitoussi
 */
class GMW_Taxonomy_Location {

    /**
     * __Constructor
     */
    function __construct() {
        add_shortcode( 'gmw_taxonomy_location', array( $this, 'get_taxonomy_location' ) );
    }

    public function get_taxonomy_location( $args) {
	    /**
	     * @var $element_id int
	     * @var $tt_id int
	     * @var $term_title int
	     ...
	     * @var $map int
	     * @var $map_height string
	     * @var $map_width string
	     * @var $map_type string
	     * @var $zoom_level int
    	...
    	*/
        ...
        $location_wrap_start = '<div id="gmw-single-post-sc-' . $element_id . '-wrapper" class="gmw-single-post-sc-wrapper gmw-single-post-sc-wrapper-'.$tt_id.'">';
       
        $location_title = '';
        if ( $term_title == 1 ) {
        	$location_title = '<h3>'. get_term_by('term_taxonomy_id', $tt_id)->name . '</h3>';
        } 
        ...
        return apply_filters( 'gmw_tx_taxonomy_location_output', $output, $args, $location_wrap_start, $location_title, $location_map, $location_distance, $location_info, $location_directions, $location_wrap_end );
    }
}
new GMW_Taxonomy_Location();
