...
jQuery(document).ready(function($) {
    ...
    var zoomLevel = gmwSettings.taxonomy_settings.edit_taxonomy_zoom_level;
	/*
	...
	if ( $('#_wppl_lat').val() != '' && $('#_wppl_long').val() != '' ) {
		  ...
		  initLng = $('#_wppl_long').val();
  		  ...
  		  initLat = gmwSettings.taxonomy_settings.edit_taxonomy_latitude;
		  initLng = gmwSettings.taxonomy_settings.edit_taxonomy_longitude;
	}
  ...
  var addresspicker = jQuery( "#addresspicker" ).addresspicker();
	...
	$('#publish').click(function(e) {
		...
		if ( gmwOptions.taxonomy_settings.mandatory_address == 1 ) {
