<?php 
/**
 * Taxonomy Locator "gray" search form template file.
 * 
...
<div class="gmw-form-wrapper gmw-form-wrapper<?php echo $gmw['ID']; ?> gmw-tx-form-wrapper gmw-tx-gray-form-wrapper">
