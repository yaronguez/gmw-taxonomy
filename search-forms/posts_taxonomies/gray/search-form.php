<?php 
/**
 * Posts by Taxonomy Locator "gray" search form template file.
 * 
...
<div class="gmw-form-wrapper gmw-form-wrapper<?php echo $gmw['ID']; ?> gmw-pt-tx-form-wrapper gmw-pt-tx-gray-form-wrapper">
