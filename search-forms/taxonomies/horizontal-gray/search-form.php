<?php 
/**
 * Taxonomy Locator "horizontal-gray" search form template file.
 * 
 ...
 * your-theme's-or-child-theme's-folder/geo-my-wp/taxonomies/search-forms/
 * 
...
<div class="gmw-form-wrapper gmw-form-wrapper<?php echo $gmw['ID']; ?> gmw-tx-form-wrapper gmw-tx-horizontal-gray-form-wrapper">
	...
	<form class="gmw-form gmw-form-<?php echo $gmw['ID']; ?>" name="gmw_form" action="<?php echo $gmw['search_results']['results_page']; ?>" method="get">
		...
		<!-- taxonomies dropdown -->
		<?php //gmw_tx_form_taxonomies_dropdown( $gmw, false, false, false ); ?>
