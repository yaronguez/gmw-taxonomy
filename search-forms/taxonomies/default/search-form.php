<?php 
/**
 * Taxonomy Locator "default" search form template file.
 * 
...
<div class="gmw-form-wrapper gmw-form-wrapper-<?php echo $gmw['ID']; ?> gmw-tx-form-wrapper gmw-tx-default-form-wrapper">
